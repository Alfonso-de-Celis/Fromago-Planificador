const VERSION='11.4';
const CACHE='fromago-secure-v11-4';
const CORE=['./','./index.html','./manifest.webmanifest','./icon-192.png','./icon-512.png','./secure-v11.js','./secure-v10.js','./locations-data-v11.js','./locations-ui-v11.js','./program-ui-v11.js','./status-ui-v11.js','./sync-config.js'];
...
self.addEventListener('fetch',event=>{
  ...
  if(/\/(secure-v11\.js|secure-v10\.js|locations-data-v11\.js|locations-ui-v11\.js|program-ui-v11\.js|status-ui-v11\.js|sync-config\.js|sw\.js)$/.test(url.pathname)){
