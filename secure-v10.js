...
(async()=>{try{await load('./secure-v11.js?v=11');await load('./locations-data-v11.js?v=11.1');await load('./locations-ui-v11.js?v=11.2');await load('./program-ui-v11.js?v=11.3');await load('./status-ui-v11.js?v=11.4')}catch(e){const app=document.getElementById('app');if(app)app.innerHTML='<div class="empty">No se pudo cargar la versión actual. Comprueba la conexión y vuelve a abrir la aplicación.</div>'}})();
})();
