...
@media(max-width:600px){
 ...
 .card{width:100%;max-width:100%;padding:11px;border-radius:14px;margin:7px 0}.title{font-size:15px;line-height:1.2;margin:7px 0 6px}.meta,.details{font-size:11px;overflow-wrap:anywhere}.badge{font-size:9px;padding:4px 6px}.time{font-size:12px}.actions{margin-top:9px}
...
if(typeof baseRenderProgram==='function')window.renderProgram=function(){baseRenderProgram();ensureSpaceButton()};
ensureSpaceButton();
